...
function Affix(baseProps: PropsWithChildren<AffixProps>, ref) {
  ...
  const props = useMergeProps<PropsWithChildren<AffixProps>>(baseProps, defaultProps, componentConfig?.Affix);
  const {
    className,
    style,
    affixClassName,
  ...
  return (
    <ResizeObserver onResize={updatePosition}>
      <div className={classNames(className)} style={style} ref={wrapperRef}>
        ...
        <div className={classes} style={{ ...fixedStyles, ...(isObject(affixStyle) ? affixStyle : {}) }}>
